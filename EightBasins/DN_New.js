...
var ProvinceList = ['Anhui', 'Fujian', 'Zhejiang']
...
for(var year=2010;year<=2022;year++){
  ...
  for(var j=0; j<ProvinceList.length; j++){
    ...
    var table = ee.FeatureCollection("users/FJX/Province-Basin/DN/"+ loc +"_DN");
  ...
  *****************************************************************/
  ...
  Export.table.toDrive({
      ...
      fileNamePrefix: year+'_DN'+'_mean',
      description: year+'_DN'+'_mean',
      folder:'DN_NEW',
      fileFormat: 'CSV'
    });
  print("DN Basin: ", year)
