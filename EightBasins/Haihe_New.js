...
var ProvinceList = ['Beijing', 'Hebei', 'Henan', 'Liaoning', 'Neimenggu',
'Shanxi', 'Shandong', 'Tianjin']
...
for(var year=2010;year<=2022;year++){
  ...
  for(var j=0; j<ProvinceList.length; j++){
    ...
    var table = ee.FeatureCollection("users/FJX/Province-Basin/HaiHe/"+ loc +"_HaiHe");
  ...
  *****************************************************************/
  ...
  Export.table.toDrive({
      ...
      fileNamePrefix: year+'_HaiHe'+'_mean_0125',
      description: year+'_HaiHe'+'_mean',
      folder:'HaiHe_New',
      fileFormat: 'CSV'
    });
  print("HaiHe Basin: ", year)
