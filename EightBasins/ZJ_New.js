...
var ProvinceList = ['Fujian', 'Guangdong', 'Guangxi', 'Guizhou',
...
for(var year=2010;year<=2022;year++){
  ...
  for(var j=0; j<ProvinceList.length; j++){
    ...
    var table = ee.FeatureCollection("users/FJX/Province-Basin/ZJ/"+ loc +"_ZJ");
  ...
  *****************************************************************/
  ...
  Export.table.toDrive({
      ...
      fileNamePrefix: year+'_ZJ'+'_mean',
      description: year+'_ZJ'+'_mean',
      folder:'ZJ_New',
      fileFormat: 'CSV'
    });
  print("ZJ Basin: ", year)
