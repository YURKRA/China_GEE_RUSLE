...
var ProvinceList = ['Anhui', 'Henan', 'Jiangsu', 'Shandong']

var LS_province = ['Neimenggu', 'Qinghai', 'Sichuan', 'Xinjiang', 'Xizang','Yunnan']
...
/*****************************************************************
        * import the LULC dataset: CLCD 1985-2022
*****************************************************************/
var imgPathCLCD = 'users/studyroomGEE/LULC_Dataset/LULC_HuangXin/CLCD_v01_';
...
for(var year=2010;year<=2022;year++){
  ...
  for(var j=0; j<ProvinceList.length; j++){
    ...
    var table = ee.FeatureCollection("users/FJX/Province-Basin/HuaiHe/"+ loc +"_HuaiHe");
  ...
  *****************************************************************/
    ...
    //   ]),
    //   fileNamePrefix: loc+''+year+'_mean',
    //   description: loc+''+year+'_mean',
    //   folder:'HuaiHe',
    //   fileFormat: 'CSV'
    // });
  ...
  Export.table.toDrive({
      ...
      fileNamePrefix: year+'_HuaiHe'+'_mean_0125',
      description: year+'_HuaiHe'+'_mean',
      folder:'HuaiHe_New',
      fileFormat: 'CSV'
    });
  print("HuaiHe Basin: ", year)
  // print('the mean value is:', mean.get("A"))
}
