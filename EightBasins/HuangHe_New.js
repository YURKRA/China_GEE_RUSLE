...
var ProvinceList = ['Gansu', 'Henan', 'Neimenggu', 'Ningxia', 'Qinghai', 'Shan_xi',
...
for(var year=2010;year<=2022;year++){
  ...
  for(var j=0; j<ProvinceList.length; j++){
    ...
    var table = ee.FeatureCollection("users/FJX/Province-Basin/HuangHe/"+ loc +"_HuangHe");
  ...
  *****************************************************************/
  ...
  Export.table.toDrive({
      ...
      fileNamePrefix: year+'_HuangHe'+'_mean',
      description: year+'_HuangHe'+'_mean',
      folder:'HuangHe_New',
      fileFormat: 'CSV'
    });
  print("HuangHe Basin: ", year)
