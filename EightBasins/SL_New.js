...
var ProvinceList = ['Hebei', 'Heilongjiang', 'Jilin', 'Liaoning',
'Neimenggu']
...
for(var year=2010;year<=2022;year++){
  ...
  for(var j=0; j<ProvinceList.length; j++){
    ...
    var table = ee.FeatureCollection("users/FJX/Province-Basin/SL/"+ loc +"_SL");
  ...
  *****************************************************************/
    ...
    var A_1 = A.where(A.lt(0), 0).clip(table)
  ...
  Export.table.toDrive({
      ...
      fileNamePrefix: year+'_SL'+'_mean',
      description: year+'_SL'+'_mean',
      folder:'SL_New',
      fileFormat: 'CSV'
    });
  print("SL Basin: ", year)
